...
This repository contains the technical reference documentation **"Introduction to Anatra"** - comprehensive guide to running research computing workloads on the University of Bath's High-Performance Computing (HPC) system.
